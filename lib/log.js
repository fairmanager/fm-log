...
var Logger = (function() {
  ...
  Logger.prototype.debug = function( message ) {
    var toLog = generateLogStack( "[DEBUG ]", this.prefix, message );
  ...
  Logger.prototype.notice = function( message ) {
    var toLog = generateLogStack( "[NOTICE]", this.prefix, message );
  ...
  Logger.prototype.warn = function( message ) {
    var toLog = generateLogStack( "[WARN  ]", this.prefix, message );
  ...
  Logger.prototype.critical = function( message ) {
    var toLog = generateLogStack( "[CRITIC]", this.prefix, message );
