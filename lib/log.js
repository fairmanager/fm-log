...
var Logger = (function() {
  ...
  Logger.prototype.debug = function( message ) {
    var toLog = generateLogStack( "[DEBUG ]", this.prefix, message, colors.grey );
    this.log( toLog, this.debug.bind( this ) );
  };
  /**
  ...
  Logger.prototype.info = function( message ) {
    var toLog = generateLogStack( "[INFO  ]", this.prefix, message, colors.cyan );
  ...
  Logger.prototype.notice = function( message ) {
    var toLog = generateLogStack( "[NOTICE]", this.prefix, message, colors.green );
    this.log( toLog, this.notice.bind( this ) );
  };
  /**
   * Log a warning.
   * @param {String} message The message to log.
  ...
  Logger.prototype.warn = function( message ) {
    var toLog = generateLogStack( "[WARN  ]", this.prefix, message, colors.yellow );
    this.log( toLog, this.warn.bind( this ) );
  };
  /**
   * Log an error.
   * @param {String} message The message to log.
  ...
  Logger.prototype.error = function( message ) {
    ...
    var toLog = generateLogStack( "[ERROR ]", this.prefix, message, colors.red );
  ...
  Logger.prototype.critical = function( message ) {
    var toLog = generateLogStack( "[CRITIC]", this.prefix, message, function( str ) {return colors.bold( colors.red( str ) ); } );
    this.log( toLog, this.critical.bind( this ) );
  };
  // Aliases
