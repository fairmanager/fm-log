...
var Logger = ( function iife() {
	...
	Logger.prototype.stderr = function Logger$stderr() {
		return this.to( process.stderr );
	};

	Logger.prototype.stdout = function Logger$stdout() {
		return this.to( process.stdout );
	};
...
Object.defineProperty( module.exports, "moduleMaxLength", {
	get : function() {
		return moduleMaxLength;
	},
	set : function( length ) {
		moduleMaxLength = length;
	}
} );

Object.defineProperty( module.exports, "defaultStream", {
	get : function() {
