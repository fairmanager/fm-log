...
class Logger {
	 ...
	 * @param {Function} morganFactory A reference to the morgan constructor function.
	 ...
	 */
	morgan( morganFactory, format, options, how ) {
		...
		const morgan    = morganFactory( format, options );
